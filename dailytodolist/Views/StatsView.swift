...
#Preview("Stats View") {
    ...
    // Create sample tasks
    let task1 = TodoTask(title: "Morning Exercise", category: "Health", isRecurring: true)
    let task2 = TodoTask(title: "Buy groceries", category: "Shopping")
    let task3 = TodoTask(title: "Team standup", category: "Work", isRecurring: true)
    let task4 = TodoTask(title: "Read for 30 minutes", category: "Personal", isRecurring: true)
